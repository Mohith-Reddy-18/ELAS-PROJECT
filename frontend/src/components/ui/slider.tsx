...
>(({ className, ...props }, ref) => (
  ...
  >
    ...
    <SliderPrimitive.Thumb className="block h-5 w-5 rounded-full border-2 border-sky-300 bg-white shadow-lg transition hover:scale-110 focus:outline-none focus:ring-2 focus:ring-sky-400/60" />
  </SliderPrimitive.Root>
));
